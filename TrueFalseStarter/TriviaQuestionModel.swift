...
struct TriviaQuestionModel{
    ...
    let questions: [Question] = [
        Question(question: "In terms of land, which state is Sweden closest to in size?", options: ["Texas", "California","Florida", "Montana"], answer: 1),
        Question(question: "Which singing group is NOT from Sweden?", options: ["ABBA", "Ace of Base", "The Cranberries", "The Cardigans"], answer: 2),
        Question(question: "What is the Swedish population?", options: ["5 million", "10 million", "15 million"], answer: 1),
        Question(question: "What are the colors of the Swedish flag?", options: ["red & yellow", "red & white", "blue & white", "blue & yellow"], answer: 3),
        ...
        Question(question: "What % of Swedes speak English?", options: ["66%", "86%", "91%"], answer: 1)
    ]
